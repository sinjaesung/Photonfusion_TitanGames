...
namespace MultiClimb.Menu
{
    public class MenuConnection : IFusionMenuConnection
    {
        ...
        public async Task<ConnectResult> ConnectAsync(IFusionMenuConnectArgs connectArgs)
        {
            ...
            var availableScenes = _config.AvailableScenes;
            Debug.Log("MenuConnection ConnectAsync Link Scene>>" + FusionMenuUIMain.SelectSceneIndex);
            Debug.Log("MenuConnection ConnectAsync Link Scene Name>>" + availableScenes[FusionMenuUIMain.SelectSceneIndex].ScenePath);
            sceneInfo.AddSceneRef(sceneManager.GetSceneRef(availableScenes[FusionMenuUIMain.SelectSceneIndex].ScenePath/*connectArgs.Scene.ScenePath*/), LoadSceneMode.Additive);
